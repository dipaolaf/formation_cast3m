...
\begin{frame}{\fe{Développement : sources Esope}{Development: Esope sources}}
  \begin{itemize}
    ...
    \kwr{compilcast26  } \kw{toto.eso titi.eso ...}
    \item \fe{Édition des liens}{Linking}\\
    \kwr{essaicast26}\\
    \fe{$\Rightarrow$ création d'un fichier exécutable binaire : \g{\kwg{cast\_26}}}
       {$\Rightarrow$ creation of a binary executable file: \g{\kwg{cast\_26}}}\\
