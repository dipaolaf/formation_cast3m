...
\begin{frame}{\fe{1.1 Maillage non structuré}{1.1 Unstructured mesh}}
  ...
  \onslide<2->{
    ...
    \end{textblock*}}
  \onslide<3>{\footnotesize \avous{\fe{Maillage du cercle de centre p6}{Meshing the circle with center p6}} \normalsize}
  \onslide<4->{
...
\begin{frame}{\fe{1.2 Maillage structuré}{1.2 Structured mesh}}
  ...
  \end{textblock*}
  \item<2->\fe{Maillage du volume par translation}{Meshing the volume by translation}
...
\begin{frame}{\fe{1.2 Maillage structuré}{1.2 Structured mesh}}
  ...
  \lstinputlisting[language=gibiane, firstline=215, lastline=216]{dgibi/formation_debutant_1_maillage.dgibi}
  \end{itemize}
\end{frame}
