...
\newcommand{\avous}[1]{\gray{\ding{43}{\emph{#1}}}}
...
\begin{frame}{\fe{Sommaire}{Summary}}
  \begin{itemize}
    \item \hyperlink{presentation}{\fe{Présentation de Cast3M}{Introduction to Cast3M}}
    \item \hyperlink{gibiane}{\fe{Le langage Gibiane}{Gibiane language}}
    \item \hyperlink{maillage}{\fe{Travaux dirigés}{Tutorial class}}\\
          \begin{center}
          ...
          \includegraphics[height=0.22\textheight]{images/exo/1.2_maillage_hexa.4} \hspace{2mm}
          \includegraphics[height=0.25\textheight]{images/exo/2.1_temperatures.3} \hspace{2mm}
          \includegraphics[height=0.25\textheight]{images/exo/8_contraintes}
          \end{center}
    \item \hyperlink{complements}{\fe{Compléments}{Complements}}
  \end{itemize}
\end{frame}
