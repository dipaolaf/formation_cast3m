...
\begin{frame}{\fe{2.1 Thermique linéaire}{2.1 Linear thermal analysis}}
  ...
  \begin{itemize}
    ...
    \lstinputlisting[language=gibiane, firstline=104, lastline=104]{dgibi/formation_debutant_2_thermique.dgibi}
    \begin{textblock*}{5cm}(8.6cm,-2.8cm)
      \includegraphics[width=3.5cm]{images/exo/2.1_cl_flux_temperature}
    \end{textblock*}
    \onslide<2->{
      \lstinputlisting[language=gibiane, firstline=107, lastline=112]{dgibi/formation_debutant_2_thermique.dgibi}}
    \onslide<3->{
      \lstinputlisting[language=gibiane, firstline=114, lastline=116]{dgibi/formation_debutant_2_thermique.dgibi}
      \begin{flushright}
        \footnotesize
...
\begin{frame}{\fe{2.1 Thermique linéaire}{2.1 Linear thermal analysis}}
  ...
  \begin{itemize}
    ...
    \lstinputlisting[language=gibiane, firstline=118, lastline=119]{dgibi/formation_debutant_2_thermique.dgibi}
    \onslide<2->{\lstinputlisting[language=gibiane, firstline=126, lastline=126]{dgibi/formation_debutant_2_thermique.dgibi}}
    \onslide<3->{\lstinputlisting[language=gibiane, firstline=127, lastline=127]{dgibi/formation_debutant_2_thermique.dgibi}}
    \onslide<4->{\lstinputlisting[language=gibiane, firstline=129, lastline=129]{dgibi/formation_debutant_2_thermique.dgibi}}
    \onslide<4->{\lstinputlisting[language=gibiane, firstline=131, lastline=131]{dgibi/formation_debutant_2_thermique.dgibi}}
    \vspace{3cm}
    \onslide<2>{
...
\begin{frame}{\fe{2.2 Thermique linéaire}{2.2 Linear thermal analysis}}
  ...
  \begin{itemize}
    ...
    \onslide<2->{
      \lstinputlisting[language=gibiane, firstline=165, lastline=169]{dgibi/formation_debutant_2_thermique.dgibi}
      \lstinputlisting[language=gibiane, firstline=174, lastline=174]{dgibi/formation_debutant_2_thermique.dgibi}
      \begin{textblock*}{5cm}(8.6cm,-2.6cm)
        \includegraphics[width=3.5cm]{images/exo/2.2_cl_convection}
      \end{textblock*}}
    \onslide<3->{
      \lstinputlisting[language=gibiane, firstline=150, lastline=154]{dgibi/formation_debutant_2_thermique.dgibi}
      \lstinputlisting[language=gibiane, firstline=159, lastline=159]{dgibi/formation_debutant_2_thermique.dgibi}
      \begin{textblock*}{5cm}(8.6cm,-2.6cm)
        \includegraphics[width=3.5cm]{images/exo/2.2_cl_source}
      \end{textblock*}}
    \end{itemize}
...
\begin{frame}{\fe{2.2 Thermique linéaire}{2.2 Linear thermal analysis}}
  ...
  \begin{itemize}
    ...
    \onslide<2->{
      \lstinputlisting[language=gibiane, firstline=181, lastline=183]{dgibi/formation_debutant_2_thermique.dgibi}
      \begin{flushright}
        \footnotesize
    ...
    \onslide<3->{
      \lstinputlisting[language=gibiane, firstline=185, lastline=188]{dgibi/formation_debutant_2_thermique.dgibi}
      \begin{flushright}
        \footnotesize
...
\begin{frame}{\fe{2.2 Thermique linéaire}{2.2 Linear thermal analysis}}
  ...
  \begin{itemize}
    ...
    \lstinputlisting[language=gibiane, firstline=162, lastline=163]{dgibi/formation_debutant_2_thermique.dgibi}
    \begin{flushright}
      \footnotesize
    ...
    \onslide<2->{\lstinputlisting[language=gibiane, firstline=190, lastline=191]{dgibi/formation_debutant_2_thermique.dgibi}}
    \onslide<2->{\lstinputlisting[language=gibiane, firstline=198, lastline=198]{dgibi/formation_debutant_2_thermique.dgibi}}
    \vspace{3cm}
    \onslide<2->{
...
\begin{frame}{\fe{Remarques : champs par points (CHPOINT)}
  ...
  \item \fe{Objet CHPOINT}{CHPOINT object}\\
    \footnotesize
    \fe{Représente un champ de valeurs exprimées \g{aux POINTS (nœuds)}}
...
\begin{frame}{\fe{3 Thermique linéaire}{3 Linear thermal analysis}}
  ...
  \begin{itemize}
    ...
    \onslide<2->{
      \lstinputlisting[basicstyle=\ttfamily\tiny, language=gibiane, firstline=217, lastline=223]{dgibi/formation_debutant_2_thermique.dgibi}}
    \onslide<3->{
      \lstinputlisting[basicstyle=\ttfamily\tiny, language=gibiane, firstline=224, lastline=228]{dgibi/formation_debutant_2_thermique.dgibi}}
    \onslide<4->{
      \lstinputlisting[basicstyle=\ttfamily\tiny, language=gibiane, firstline=229, lastline=230]{dgibi/formation_debutant_2_thermique.dgibi}
      \lstinputlisting[basicstyle=\ttfamily\tiny, language=gibiane, firstline=231, lastline=232]{dgibi/formation_debutant_2_thermique.dgibi}}
...
\begin{frame}{\fe{3 Thermique linéaire}{3 Linear thermal analysis}}
  ...
  \begin{itemize}
    ...
    \lstinputlisting[language=gibiane, firstline=234, lastline=243]{dgibi/formation_debutant_2_thermique.dgibi}
    \item<2->\fe{Résolution avec \kwo{PASAPAS}}{Solving with \kwo{PASAPAS}}
    \onslide<2->{
      \lstinputlisting[language=gibiane, firstline=244, lastline=244]{dgibi/formation_debutant_2_thermique.dgibi}}
    \vspace{1cm}
...
\begin{frame}{\fe{3 Thermique linéaire}{3 Linear thermal analysis}}
  ...
  \begin{itemize}
    ...
    \lstinputlisting[basicstyle=\ttfamily\tiny, language=gibiane, firstline=246, lastline=252]{dgibi/formation_debutant_2_thermique.dgibi}
    \onslide<2->{
      \lstinputlisting[basicstyle=\ttfamily\tiny, language=gibiane, firstline=257, lastline=257]{dgibi/formation_debutant_2_thermique.dgibi}
      ...
      \end{textblock*}}
    \onslide<3->{
      \lstinputlisting[basicstyle=\ttfamily\tiny, language=gibiane, firstline=259, lastline=262]{dgibi/formation_debutant_2_thermique.dgibi}
      \lstinputlisting[basicstyle=\ttfamily\tiny, language=gibiane, firstline=267, lastline=267]{dgibi/formation_debutant_2_thermique.dgibi}
...
\begin{frame}{\fe{3 Thermique linéaire}{3 Linear thermal analysis}}
  ...
  \begin{itemize}
    ...
    \lstinputlisting[basicstyle=\ttfamily\tiny, language=gibiane, firstline=270, lastline=271]{dgibi/formation_debutant_2_thermique.dgibi}
    \lstinputlisting[basicstyle=\ttfamily\tiny, language=gibiane, firstline=275, lastline=280]{dgibi/formation_debutant_2_thermique.dgibi}
    \lstinputlisting[basicstyle=\ttfamily\tiny, language=gibiane, firstline=282, lastline=282]{dgibi/formation_debutant_2_thermique.dgibi}
    \lstinputlisting[basicstyle=\ttfamily\tiny, language=gibiane, firstline=284, lastline=284]{dgibi/formation_debutant_2_thermique.dgibi}
...
\begin{frame}{\fe{4 Thermique linéaire}{4 Linear thermal analysis}}
  ...
  \begin{itemize}
    ...
    \lstinputlisting[basicstyle=\ttfamily\tiny, language=gibiane, firstline=297, lastline=306]{dgibi/formation_debutant_2_thermique.dgibi}
    \onslide<1>{
      \lstinputlisting[basicstyle=\ttfamily\tiny, language=gibiane, firstline=307, lastline=307]{dgibi/formation_debutant_2_thermique.dgibi}}
    \onslide<2>{
      \lstinputlisting[basicstyle=\ttfamily\tiny, language=gibiane, firstline=308, lastline=309]{dgibi/formation_debutant_2_thermique.dgibi}}
    \lstinputlisting[basicstyle=\ttfamily\tiny, language=gibiane, firstline=310, lastline=310]{dgibi/formation_debutant_2_thermique.dgibi}
    \vspace{1cm}
...
\begin{frame}{\fe{4 Thermique linéaire}{4 Linear thermal analysis}}
  ...
  \begin{itemize}
    \item \fe{Post traitement : vecteurs flux de chaleur}
             {Post processing: vectors for heat flow}
    $\tou{\phi}=-\lambda\tou{\tx{grad}}(T)$
    \lstinputlisting[language=gibiane, firstline=312, lastline=314]{dgibi/formation_debutant_2_thermique.dgibi}
    \lstinputlisting[language=gibiane, firstline=319, lastline=319]{dgibi/formation_debutant_2_thermique.dgibi}
    ...
    \onslide<2->{
      \lstinputlisting[language=gibiane, firstline=328, lastline=329]{dgibi/formation_debutant_2_thermique.dgibi}
    ...
    \onslide<3->{
      \lstinputlisting[language=gibiane, firstline=330, lastline=330]{dgibi/formation_debutant_2_thermique.dgibi}}
  \end{itemize}
  \vspace{2cm}
\end{frame}
...
\begin{frame}{\fe{5 Thermique non linéaire}{5 Non linear thermal analysis}}
  ...
  \begin{itemize}
    ...
    \onslide<2->{
      \lstinputlisting[language=gibiane, firstline=360, lastline=362]{dgibi/formation_debutant_2_thermique.dgibi}}
  \end{itemize}
\end{frame}
...
\begin{frame}{\fe{5 Thermique non linéaire}{5 Non linear thermal analysis}}
  ...
  \begin{itemize}
    ...
    \onslide<2->{
      \lstinputlisting[language=gibiane, firstline=364, lastline=374]{dgibi/formation_debutant_2_thermique.dgibi}}
  \end{itemize}
\end{frame}
...
\begin{frame}{\fe{5 Thermique non linéaire}{5 Non linear thermal analysis}}
  ...
  \begin{itemize}
    ...
    \lstinputlisting[basicstyle=\ttfamily\tiny, language=gibiane, firstline=379, lastline=382]{dgibi/formation_debutant_2_thermique.dgibi}
    \item<2->\fe{Tracé avec légende}{Plotting with a legend}
    \onslide<2->{
      \lstinputlisting[basicstyle=\ttfamily\tiny, language=gibiane, firstline=383, lastline=396]{dgibi/formation_debutant_2_thermique.dgibi}}
    \onslide<3->{
      \lstinputlisting[basicstyle=\ttfamily\tiny, language=gibiane, firstline=401, lastline=402]{dgibi/formation_debutant_2_thermique.dgibi}
...
\begin{frame}{\fe{5 Thermique non linéaire}{5 Non linear thermal analysis}}
  ...
  \begin{itemize}
    \item \fe{Post traitement : boucle de tracés}{Post processing: loop for plot}
    \lstinputlisting[basicstyle=\ttfamily\tiny, language=gibiane, firstline=410, lastline=415]{dgibi/formation_debutant_2_thermique.dgibi}
    \lstinputlisting[basicstyle=\ttfamily\tiny, language=gibiane, firstline=417, lastline=417]{dgibi/formation_debutant_2_thermique.dgibi}
    \lstinputlisting[basicstyle=\ttfamily\tiny, language=gibiane, firstline=419, lastline=419]{dgibi/formation_debutant_2_thermique.dgibi}
    \begin{textblock*}{5cm}(6.2cm,-1.3cm)
      \if \animation 1
        \animategraphics[controls,loop,poster=last,width=6cm]{10}{images/exo/5_temperatures.}{001}{101}
      \else
        \includegraphics[width=6cm]{images/exo/5_temperatures.101}
      \fi
    \end{textblock*}
    \vspace{1cm}
    \item<2->\fe{Sauvegarde des données}{Saving data}
    \lstinputlisting[basicstyle=\ttfamily\tiny, language=gibiane, firstline=445, lastline=448]{dgibi/formation_debutant_2_thermique.dgibi}
  \end{itemize}
\end{frame}
