...
\begin{frame}{\fe{Mécanique}{Mechanical analysis}}{\fe{Rappels}{Reminders}}
  \begin{itemize}
...
\begin{frame}{\fe{Mécanique}{Mechanical analysis}}{\fe{Rappels}{Reminders}}
  \begin{itemize}
    \item \fe{Hypothèse des petites déformations :}{Small strains hypothesis:} $\{\varepsilon\}=[B]\{U\}$
    \item \fe{Élasticité linéaire :}{Linear elasticity:} $\{\sigma\}=[C]\{\varepsilon\}$
    \begin{block}{\fe{[HPP] Formulation faible et discrétisée de l'équilibre :}
...
\begin{frame}{\fe{6 Mécanique linéaire}{6 Linear mechanical analysis}}
...
\begin{frame}{\fe{6 Mécanique linéaire}{6 Linear mechanical analysis}}
  ...
  \begin{itemize}
    ...
    \begin{textblock*}{5cm}(8.7cm,-2.5cm)
      \begin{tikzpicture}
        \scriptsize
        \node[anchor=south west,inner sep=0] (image) at (0,0)
...
\begin{frame}{\fe{7 Mécanique linéaire}{7 Linear mechanical analysis}}
...
\begin{frame}{\fe{8 Mécanique linéaire}{8 Linear mechanical analysis}}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
        \footnotesize
        \item[] $\mu=\frac{l}{2}$ \fe{valeur moyenne de $x$}{mean value of $x$}
      \item[] $\sigma=\frac{l}{5}$ \fe{écart type}{standard deviation of $x$}
    \end{itemize}
    \normalsize
    \onslide<2->{
...
\begin{frame}{\fe{9.1 Mécanique non linéaire}{9.1 Non linear mechanical analysis}}
