...
\begin{frame}{\fe{Procédures utilisateur}{User procedures}}{\fe{Mode d'emploi}{Instructions for use}}
  ...
  \begin{enumerate}
    ...
    \item \fe{\g{\blue{Observer la syntaxe de la procédure}}\\
              dans le code de \kwo{PASAPAS} \dots~ou bien voir le tableau suivant}
...
\begin{frame}{\fe{Procédures utilisateur}{User procedures}}
  ...
  \begin{itemize}
    ...
    \begin{textblock*}{6cm}(8.5cm,3.5cm)
      ...
      \else
        \includegraphics[width=3.6cm]{images/exemple/exemple_1.21}
      \fi
    \end{textblock*}
...
\begin{frame}{\fe{Procédures utilisateur}{User procedures}}
  ...
  \begin{itemize}
    ...
    \begin{textblock*}{6cm}(8.5cm,3.5cm)
      ...
      \else
        \includegraphics[width=3.6cm]{images/exemple/exemple_2.21}
      \fi
    \end{textblock*}
