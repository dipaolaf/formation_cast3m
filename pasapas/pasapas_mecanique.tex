...
\begin{frame}{\fe{Algorithme de UNPAS}{UNPAS algorithm}}
  ...
  \fe{\node (eq0) [note, right of=eq, xshift=1.5cm, anchor=west] {Mesure normée du résidu $<$ critère ? \kwg{'PRECISION' 'FTOL' 'MTOL'}\\
                                                                  Variation de l'incrément de déformations entre 2 itérations $<$ critère ?};}
     {\node (eq0) [note, right of=eq, xshift=1.5cm, anchor=west] {Magnitude of the imbalance $<$ criterion? \kwg{'PRECISION' 'FTOL' 'MTOL'}\\
