...
\begin{frame}{\fe{Quelques références utilisées pour cette formation}
  ...
  \begin{itemize}
    ...
    \item \g{S. Pascal}\\
          Cast3M, éléments de théorie -- Statique, CEA, 2020
    \item \g{E. Jeanvoine, A. De Gayffier}\\
          La thermique transitoire et le couplage faible thermique-mécanique dans Castem2000, CEA, 1995
    \item \g{Murata Software}\\
          Test Case of Temperature-Dependent Heat Source (Transient Analysis)\\
          \url{https://www.muratasoftware.com/en/products/examples/wat017/}
  \end{itemize}
\end{frame}
