...
\begin{frame}{\fe{Sommaire}{Summary}}
  \begin{itemize}
    ...
    \item \fe{\hyperlink{mecanique_equations}{\blue{Équilibre mécanique statique}} - \hyperlink{unpas}{procédure UNPAS}\\
              $\rightarrow$ exercice 1~: \blue{force suiveuse}\\
              $\rightarrow$ exercice 2~: \blue{rupture par suppression d'éléments}}
             {\hyperlink{mecanique_equations}{\blue{Mechanical static equilibrium}} - \hyperlink{unpas}{procedure UNPAS}\\
              $\rightarrow$ exercice 1: \blue{following force}\\
              $\rightarrow$ exercice 2: \blue{fracture by elements removal}}
    \item \fe{\hyperlink{thermique_equations}{\red{Équilibre thermique}} - \hyperlink{transnon}{procédure TRANSNON}\\
              $\rightarrow$ exercice 3~: \red{source de chaleur variable}\\
              $\rightarrow$ exercice 4~: contact \red{thermo} \blue{mécanique}}
             {\hyperlink{thermique_equations}{\red{Thermal equilibrium}} - \hyperlink{transnon}{procedure TRANSNON}\\
