...
\begin{frame}{\fe{Exercice 2 : fissuration par suppression d'éléments}
  ...
  \begin{itemize}
    ...
    \else
      \includegraphics[height=3.5cm]{images/exo/exo_2_sigma.11} \hspace{0.2cm}
    \fi
...
\begin{frame}{\fe{Exercice 2 : fissuration par suppression d'éléments}
  ...
  \begin{itemize}
    ...
    \kwr{ELEM} \fe{sélection des éléments où un champ vérifie une condition}{select the elements of a field that meets a criteria}\\
...
\begin{frame}{\fe{Exercice 2 : fissuration par suppression d'éléments}
  ...
  \begin{itemize}
    ...
    \else
      \includegraphics[height=4.5cm]{images/exo/exo_2_solu_sigma.47} \hspace{1.5cm}
    \fi
...
\begin{frame}{\fe{Exercice 2 : fissuration par suppression d'éléments}
  ...
  \begin{itemize}
    ...
    \else
      \includegraphics[height=4.5cm]{images/exo/exo_2_solu_bis_sigma.47} \hspace{1.5cm}
    \fi
