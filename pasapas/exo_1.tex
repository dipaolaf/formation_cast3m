...
\begin{frame}{\fe{Exercice 1 : poutre avec force suiveuse}{Exercise 1: beam with following force}}
  ...
  \begin{textblock*}{10cm}(0.4cm,-4.2cm)
    ...
    \lstinputlisting[basicstyle=\ttfamily\tiny, language=gibiane, firstline=78, lastline=79]{dgibi/formation_pasapas_1_solution.dgibi}
  \end{textblock*}
...
\begin{frame}{\fe{Exercice 1 : poutre avec force suiveuse}{Exercise 1: beam with following force}}
  ...
  \begin{textblock*}{10cm}(0.3cm,-4.3cm)
    \fe{\emph{Programme principal}}{\emph{Main program}}
    \lstinputlisting[basicstyle=\ttfamily\tiny, language=gibiane, firstline=114, lastline=116]{dgibi/formation_pasapas_1_solution.dgibi}
  \end{textblock*}
  \begin{textblock*}{10cm}(5.8cm,-4.3cm)
    \fe{\emph{\violet{Procédure CHARMECA}}}{\emph{\violet{CHARMECA procedure}}}
    \lstinputlisting[basicstyle=\ttfamily\tiny, language=gibiane, firstline=56, lastline=68]{dgibi/formation_pasapas_1_solution.dgibi}
  \end{textblock*}
\end{frame}
