...
\begin{frame}{\fe{Exercice 1 : poutre avec force suiveuse}{Exercise 1: beam with following force}}
  ...
  \begin{center}
    ...
    \else
      \includegraphics[height=3.5cm]{images/exo/exo_1_deformee.201}
    \fi
...
\begin{frame}{\fe{Exercice 1 : poutre avec force suiveuse}{Exercise 1: beam with following force}}
  ...
  \begin{itemize}
    ...
    \small
    \kwg{ESTIMATION}\kw{.}\kwg{DEPLACEMENTS} \fe{dernier champ de déplacement convergé}{last converged displacement field}
...
\begin{frame}{\fe{Exercice 1 : poutre avec force suiveuse}{Exercise 1: beam with following force}}
  ...
  \begin{itemize}
    ...
    \item \fe{Créer un objet CHARGEMEnt et écraser \kwg{WTABLE}\kw{.}\kwg{CHARGEMENT}}
             {Create an load (CHARGEMEnt object) and overwrite \kwg{WTABLE}\kw{.}\kwg{CHARGEMENT}}
  \end{itemize}
  \vspace{4.5cm}
  \scriptsize
...
\begin{frame}{\fe{Exercice 1 : poutre avec force suiveuse}{Exercise 1: beam with following force}}
  ...
  \begin{center}
    ...
    \else
      \includegraphics[height=3.5cm]{images/exo/exo_1_solu_deformee.201}
    \fi
