...
\begin{frame}{\fe{Exercice 3 : dépendance à la température}
  ...
  \begin{itemize}
    ...
    \begin{textblock*}{5cm}(6.3cm,-2cm)
      \fe{Avec \kwv{CHARMECA}}{With \kwv{CHARMECA}}
      \includegraphics[width=5cm]{images/exo/exo_3_solu_bis_evol}
    \end{textblock*}
%    \hspace{5cm} \fe{Avec \kwv{CHARMECA}}{With \kwv{CHARMECA}} \vspace{2mm} \\
%    \hspace{5cm} \includegraphics[width=5cm]{images/exo/exo_3_solu_bis_evol}
  \end{itemize}
\end{frame}
