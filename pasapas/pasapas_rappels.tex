...
\begin{frame}{\fe{Aperçu des paramètres d'entrée}{Overview of input parameters}}
  \begin{itemize}
    ...
    \tiny
    \begin{tabular}{lll}
    \kwg{'MODELE'}           & MMODEL   & \fe{Équations à résoudre, formulation E.F. (\kwr{MODE})}
                                             {Equations to solve, F. E. formulation (\kwr{MODE})}\\
    ...
    \kwg{'CHARGEMENT'}       & CHARGEME & \fe{Évolution des C.L. au cours du calcul (\kwr{CHAR})}
                                             {Boundary conditions and loading variation during calculation (\kwr{CHAR})}\\
    \end{tabular}
    \normalsize
    \item \fe{Thermique}{Thermal analysis}\\
    \tiny
    \begin{tabular}{lll}
    \kwg{'BLOCAGES\_THERMIQUES'} & RIGIDITE & \fe{Matrice de blocage des C.L. de type DIRICHLET (\kwr{BLOQ})}
                                                 {Stiffness matrix for DIRICHLET B.C. (\kwr{BLOQ})}\\
    ...
    \tiny
    \begin{tabular}{lll}
    \kwg{'BLOCAGES\_MECANIQUES'}           & RIGIDITE & \fe{Matrice de blocage des C.L. de type DIRICHLET (\kwr{BLOQ})}
                                                           {Stiffness matrix for DIRICHLET B.C. (\kwr{BLOQ})}\\
    ...
    \kwg{'DEPLACEMENTS' . 0}               & CHPOINT  & \fe{Conditions initiales}
                                                           {Initial conditions}\\
    \kwg{'CONTRAINTES' . 0}                & MCHAML   & \fe{Conditions initiales}
                                                           {Initial conditions}\\
    \kwg{'VARIABLES\_INTERNES' . 0}        & MCHAML   & \fe{Conditions initiales}
                                                           {Initial conditions}\\
    \kwg{'DEFORMATIONS\_INELASTIQUES' . 0} & MCHAML   & \fe{Conditions initiales}
                                                           {Initial conditions}\\
    \end{tabular}
    \normalsize
    ...
    \kwg{'VITESSES' . 0}       & MCHAML   & \fe{Conditions initiales}
                                               {Initial conditions}\\
    \kwg{'ACCELERATIONS' . 0 } & CHPOINT  & \fe{Conditions initiales}
                                               {Initial conditions}\\
    \end{tabular}
    \normalsize
