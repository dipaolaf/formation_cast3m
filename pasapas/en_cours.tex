...
\begin{frame}{\fe{Exercice 2 : fissuration par suppression d'éléments}
  ...
  \begin{itemize}
    ...
    \begin{center}
      ...
      \hspace{0.1cm}
      \animategraphics[controls,loop,poster=last,height=3.5cm]{7}{images/exo/exo_2_sigma.}{01}{11}
      \hspace{0.1cm}
...
\begin{frame}{\fe{Exercice 2 : fissuration par suppression d'éléments}
  ...
  \begin{itemize}
    ...
    \begin{center}
      \animategraphics[controls,loop,poster=last,height=4cm]{7}{images/exo/exo_2_solu_sigma.}{01}{47}
      \hspace{0.4cm}
